...
export class ArrowShapeUtil extends ShapeUtil<TLArrowShape> {
	...
	override onHandleChange: TLOnHandleChangeHandler<TLArrowShape> = (shape, { handle }) => {
		...
		const wasPrecise = currentBinding?.props.isPrecise ?? false
		let isPrecise = wasPrecise
